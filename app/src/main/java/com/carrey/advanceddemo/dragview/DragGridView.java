...
//    private long dragResponseMS = 1000;
     ...
     * 刚开始拖拽的item对应的View
     */
    public View mStartDragItemView = null;
...
//            mVibrator.vibrate(50); //震动一下
            ...
            mDragAdapter.showDelIcon();
            //根据我们按下的点显示item镜像
            removeDragImage();
            createDragImage(mDragBitmap, mDownX, mDownY);
            isLocked=false;
//            YiYaoUtils.statisticsEvent(StatisticsConstant.SUBSCRIBE_LONGPRESSDELETE);
...
//                }
     ...
     * @return
     */
    public boolean isTouchInItem(View dragView, int x, int y){
        if(dragView == null){
            return false;
        }
...
//                System.out.println(pos);
    ...
    public  void onStop(){
        if(null!=mStartDragItemView) {
            mStartDragItemView.setVisibility(View.VISIBLE);
        }
            mDragAdapter.setHideItem(-1);
            removeDragImage();
        mDragAdapter.hidDelIcon();
            setDrag(false);
        }
